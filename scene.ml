...
let niveau1 = [("Sprite/map.bmp", Wallpaper, 0,0);("Sprite/S1.bmp",Perso,100,927);
...
(* Toujours la meme fonction mais pour les bonus *)
...
renvoie la texture correspondant à l'état du personnage passé en argument *)
